...
\Title{A Minimal Working Example of a Journal Paper using \LaTeX{} in the MDPI format}

% MDPI internal command: Title for citation in the left column
\TitleCitation{A Minimal Working Example of a Journal Paper using \LaTeX{} in the MDPI format}

% Author Orchid ID: enter ID or remove command
\newcommand{\orcidauthorA}{0000-0003-2128-4658} % Add \orcidB{} behind the author's name
% \newcommand{\orcidauthorB}{0000-0002-1015-7605} % Add \orcidA{} behind the author's name

% Authors, for the paper (add full first names)
%\dagger -> adds dagger
%\ddagger -> adds double dagger
\Author{Your Name$^{1}$, Another Contributor$^{1}$, Partner Name$^{2}$, Michael J. Wagner $^{1,}$\orcidA{}}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Your Name, Another Contributor, Partner Name and Michael Wagner}

% MDPI internal command: Authors, for citation in the left column
\AuthorCitation{Name, Y.; Contributor, A.; Name, P.; Wagner, M. }
% If this is a Chicago style journal: Lastname, Firstname, Firstname Lastname, and Firstname Lastname.

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad Department of Mechanical Engineering, University of Wisconsin - Madison, 1415 University Drive, Madison, WI 53706, United States\\
$^{2}$ \quad National Renewable Energy Laboratory,Thermal Systems Group, 15013 Denver West Parkway, Golden, CO 80401, United States\\
}

% Contact information of the corresponding author
\corres{Correspondence: mjwagner2@wisc.edu (M.W.); Tel.: +1-608-890-1910 (M.W.)}
