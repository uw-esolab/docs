...
% Underline and emphasize text
\usepackage{ulem}
% Allow equation breaks
\usepackage{breqn}
% Symbols and math characters
%\usepackage{bbding}
\usepackage{ wasysym }
\usepackage{amsmath, amssymb}
% Include raw PDF pages in the document
%\usepackage{pdfpages}
% Allow merging of cells across multiple rows of a table
\usepackage{multirow}
% Format captions
\usepackage{caption}
% Support pseudocode algorithms
\usepackage{algorithm}
\usepackage{algpseudocode}   %[noend]
% Convert EPS graphics to pdf format
\usepackage{epstopdf}
% Include the tikz library for drawing graphics and charts manually
\usepackage{tikz}                   
\usetikzlibrary{shadows}
% Table cell and row coloring
\usepackage{colortbl}
% 
\usepackage{adjustbox}
% Natbib bibliography support with 'numbers' 
\usepackage[numbers]{natbib}
% Option to format math fractions inline
\usepackage{nicefrac}
% Allows including images
\usepackage{graphicx} 
% Allows the use of \toprule, \midrule and \b	ottomrule in tables
\usepackage{booktabs} 
% Spacing in macros and commands
\usepackage{xspace}
% Specify line spacing 
\usepackage{setspace}
% Present text 'verbatim' on the slide
\usepackage{verbatim}
% Better appendix numbering for beamer
...
\renewcommand{\sectionpage}{
  \begingroup
    \usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{section_slide}} 
    \setbeamertemplate{footline}{}%
    \setbeamertemplate{headline}{}%
    \frame[noframenumbering]{%
      \centering 
      \titlecolor \huge \insertsection%
      }
  \endgroup
}
